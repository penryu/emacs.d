...
;       (not (memq 'font-lock-type-face (face-list))))
 (t
  ...
  (set-face-foreground 'caml-font-lock-comment-face "wheat")
  (caml-make-face-italic 'caml-font-lock-comment-face)
  (make-face 'caml-font-lock-reference-face)
  (set-face-foreground 'caml-font-lock-reference-face "wheat")
  ...
  (set-face-foreground 'caml-font-lock-function-name-face "RoyalBlue1")
  (make-face 'caml-font-lock-keyword-face)
  (set-face-foreground 'caml-font-lock-keyword-face "orchid")
